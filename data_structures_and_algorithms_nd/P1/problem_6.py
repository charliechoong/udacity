...
# the set of elements which are in A, in B, or in both A and B. For example, the union of A = [1, 2] and B = [3,
# 4] is [1, 2, 3, 4].
#
# The intersection of two sets A and B, denoted by A ∩ B, is the set of all objects that are members of both sets A
# and B. For example, the intersection of A = [1, 2, 3] and B = [2, 3, 4] is [2, 3].
#
...
linked_list_6 = LinkedList() # empty
